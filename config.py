...
FAILURE_FILE_NAME   = "_failures.json"
CORRUPTED_FILE_NAME = "_corrupted.json"

# Template paths (inside container).
# NB: filename fixed — previously shipped as 'distribuiton_template.json' (typo),
# which silently broke template loading in production.
DISTRIBUTION_TEMPLATE_PATH = os.getenv('DISTRIBUTION_TEMPLATE_PATH', '/app/distribution_template.json')
DATASET_TEMPLATE_PATH      = os.getenv('DATASET_TEMPLATE_PATH',      '/app/dataset_template.json')
